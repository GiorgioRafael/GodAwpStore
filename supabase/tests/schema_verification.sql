...
begin
  ...
  foreach required_function in array array[
    ...
    'public.create_bot_upsell_offer(text,uuid,uuid,text,jsonb,integer,text,integer)',
    'public.finalize_bot_upsell_offer(uuid,text,text,boolean,text)',
    'public.claim_lead_recovery_offers(uuid,integer)',
    'public.complete_lead_recovery_delivery(uuid,uuid,text,text)',
    'public.fail_lead_recovery_delivery(uuid,uuid,text)',
