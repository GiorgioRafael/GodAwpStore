...
export const DEFAULT_BOT_MESSAGE_CUSTOMIZATION: BotMessageCustomization = {
  ...
  storefront: {
    ...
    catalogText: "🎮 Escolha até 3 produtos e prepare-se para turbinar sua conta! 🚀✨",
    ...
    prompt: "👇🛒 **Abra a lista abaixo e selecione até 3 produtos:**",
    selectLabel: "🛒 Catálogo de produtos",
    selectPlaceholder: "✨ Clique aqui e escolha até 3 produtos ✨",
