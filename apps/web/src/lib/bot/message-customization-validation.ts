...
const ticketSchema = z.object({
  ...
  deliveryButtonLabel: textField("ticket.deliveryButtonLabel"),
  deliveryMessageText: textField("ticket.deliveryMessageText"),
  deliverySuccessText: textField("ticket.deliverySuccessText"),
  deliveryAlreadySentText: textField("ticket.deliveryAlreadySentText"),
  deliveryUnauthorizedText: textField("ticket.deliveryUnauthorizedText"),
  deliveryUnavailableText: textField("ticket.deliveryUnavailableText"),
